...
from scipy.interpolate import make_interp_spline as spline # change here
...
noise_shape = (1,1,100)
num_steps = 1000 # change here
batch_size = 64

image_shape = None

# img_save_dir = "E:\\GAN_Datasets\\curl\\NEW_TRAIN\\"
img_save_dir = "./NEW_TRAIN\\" # change here
...
data_dir =  "./ANIME_PLANET_FACES_COLOUR_ONLY_64/*.png"
